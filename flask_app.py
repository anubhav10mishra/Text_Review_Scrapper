...
def index():
    if request.method == 'POST':
        ...
        return render_template('index.html') #render the visual form of code writen in html and css
if __name__ == "__main__": #provide entry point of the this application
